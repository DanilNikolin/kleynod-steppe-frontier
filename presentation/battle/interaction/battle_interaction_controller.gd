...
func _init(
	...
	p_log_presenter: BattleLogPresenter,
...
func handle_unhandled_input(
	...
	if debug_tools_enabled and key_event.keycode == KEY_T:
...
func _apply_debug_status_to_hovered_combatant() -> void:
	...
	log_presenter.apply_debug_status(
		target,
...
func _try_use_ability_at(
	...
	log_presenter.suspend_status_signal_logging()
	...
	log_presenter.resume_status_signal_logging()
	...
	log_presenter.append_action_results(
